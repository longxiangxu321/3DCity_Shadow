...
bvh_node::bvh_node(
    ...
    if (object_span == 1) { //the number of objects that are covered by this bvh_node
        ...
        left = make_shared<bvh_node>(objects, 0, mid, time0, time1);
        right = make_shared<bvh_node>(objects, mid, objects.size(), time0, time1);
    }
